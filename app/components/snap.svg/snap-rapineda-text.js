//https://github.com/alexpineda/Snap-Svg-Text-Plugins/blob/master/snap-rapineda-text.js
    ...
    Element.prototype.wrap = function (width, align) {
        ...
        for (var i = 1; i < words.length; i++) {
            ...
            if (clen > width) {
                ...
                clen = tspan.getComputedTextLength();
                tspan.setAttributeNS(null, 'data-clen', clen);
                ...
                tspans.push(tspan);
                lastIndex = tspans.length - 2;
                if (lastIndex >= 0) lastCLen = tspans[lastIndex].getComputedTextLength() + 3;
                tspan.setAttributeNS(null, "dx", "-" + lastCLen + "px");
